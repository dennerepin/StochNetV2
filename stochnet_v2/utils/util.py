...
def visualize_genotypes(genotypes, filename):
    # TODO: add state0 and state1 (dense) in the beginning of each cell.
    ...
    gg.node("input1", fillcolor='darkseagreen2')
    gg.node("input2", fillcolor='darkseagreen2')
